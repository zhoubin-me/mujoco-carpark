...
class CarParkingEnv(gym.Env):
    def __init__(self, **kwargs):
        ...
        self.model = mujoco.MjModel.from_xml_path("mujoco_xmls/my_car.xml")
...
gym.register(
    id="CarParkingMujoco-v0",
    entry_point="car_parking_mujoco:CarParkingEnv",
)
